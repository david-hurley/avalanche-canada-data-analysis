...
conditions_today, conditions_today_plus1, conditions_today_plus2, problems = scrape(dates_to_scrape, inputs['region'])
...
# # uncomment to export scraped data to csv files
# conditions_today.to_csv('../data/current_avalanche_conditions_' + forecast_region.replace('-', '_') + '.csv')
# conditions_today_plus1.to_csv('../data/current_plus1_avalanche_conditions_' + forecast_region.replace('-', '_') + '.csv')
# conditions_today_plus2.to_csv('../data/current_plus2_avalanche_conditions_' + forecast_region.replace('-', '_') + '.csv')
